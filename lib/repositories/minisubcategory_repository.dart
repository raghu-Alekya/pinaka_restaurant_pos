...
class MiniSubCategoryRepository {
  ...
  Future<List<MiniSubCategory>> fetchMiniSubCategories(int subCategoryId) async {
    ...
    final response = await http.get(
      url,
      headers: {
        'Authorization': 'Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpc3MiOiJodHRwczpcL1wvbWVyY2hhbnRyZXN0YXVyYW50LmFsZWt0YXNvbHV0aW9ucy5jb20iLCJpYXQiOjE3NTU1ODExMzUsIm5iZiI6MTc1NTU4MTEzNSwiZXhwIjoxNzU4MTczMTM1LCJkYXRhIjp7InVzZXIiOnsiaWQiOjUsImRldmljZSI6IiIsInBhc3MiOiIyYjhlMjJlOTM2ZTY0N2JhNDRmOWJhMmY3Y2Q1ZmFjNiJ9fX0.6BQu4J11mg2dkwRmCHd9hLvpRelDSSqJkUlAliEJnUw',
