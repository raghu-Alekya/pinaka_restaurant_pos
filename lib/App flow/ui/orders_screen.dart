...
import 'guest_details_popup.dart'; // adjust the path as needed
...
class OrderPanel extends StatelessWidget {
  ...
  const OrderPanel({super.key, required token, required restaurantId,
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  const Spacer(),
                  avatarName('assets/icon/person.png', 'Guest:${guestcount?.guestCount ?? 0}'),
                  IconButton(
                    onPressed: () {
                      showDialog(
                        context: context,
