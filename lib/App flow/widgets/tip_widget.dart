    ...
    setState(() {
      ...
      if (currentText.isNotEmpty) {
        ...
        if (currentText.isEmpty) {
          ...
          _tipController.text = (double.tryParse(currentText) ?? 0)
              .toStringAsFixed(2);
        }
      }

      selectedTip = null;
      _updateTipButtonState();
    });
  }
  ...
  Future<void> _applyTip() async {
    if (_tipController.text.trim().isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Please enter tip amount'),
    ...
    if (amount <= 0) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Invalid tip amount'),
          backgroundColor: Colors.red,
          duration: Duration(seconds: 1),
        ),
      );
            ...
            side: BorderSide(
              color:
                  ...
                  (isClear
                      ...
                      : isBack
                      ? (isDark ? Colors.white24 : const Color(0xFF4C5F7D))
                    ...
                    children: [
                      ...
                      Expanded(
                        ...
                        child: GridView.count(
                          ...
                          mainAxisSpacing: 15,
                          childAspectRatio:
                              1.5, // smaller value = taller buttons
                          children: [
                            for (var i = 1; i <= 9; i++)
                              _buildKeypadButton(
                                i.toString(),
