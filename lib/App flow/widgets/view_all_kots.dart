...
class ViewAllKOTDropdown extends StatefulWidget {
  ...
  const ViewAllKOTDropdown({
    ...
    required this.token,
    required this.kots,
    required this.isExpanded, // ✅ FIXED
  });
      ...
      listeners: [
        ...
        BlocListener<OrderBloc, OrderState>(
          listener: (context, state) {
            if (_expanded != state.showKOTDropdown) {
              setState(() {
                _expanded = state.showKOTDropdown;
              });
            }
          },
        ),
        ...
        builder: (context, state) {
          ...
          return Column(
            children: [
              ...
              GestureDetector(
                onTap: () {
                  context.read<OrderBloc>().add(ToggleOrderKOTDropdown());
                },
                ...
                child: Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Transform.rotate(
                        angle:  widget.isExpanded ? 3.14 : 0,
                        child: const Icon(
