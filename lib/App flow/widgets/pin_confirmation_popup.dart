...
class PinConfirmationPopup extends StatefulWidget {
  ...
  @override
  State<PinConfirmationPopup> createState() => _PinConfirmationPopupState();
}
...
class _PinConfirmationPopupState extends State<PinConfirmationPopup> {
  ...
  Future<void> _onProceed() async {
    ...
    if (enteredPin != expectedPin) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('PIN does not match the logged-in user'),
          ...
          children: [
            ...
            Text(
              ...
              style: theme.textTheme.titleLarge?.copyWith(
                ...
                color: isDark ? Colors.white : const Color(0xFF26344D),
              ),
            ),
              ...
              children: [
                ...
                Expanded(
                  child: OutlinedButton(
                    onPressed: _isChecking ? null : _onCancel,

                    style: OutlinedButton.styleFrom(
                      minimumSize: const Size(double.infinity, 48),

                      side: BorderSide(color: widget.cancelColor, width: 1.2),
                ...
                Expanded(
                  child: ElevatedButton(
                    onPressed: _isChecking ? null : _onProceed,

                    style: ElevatedButton.styleFrom(
                      backgroundColor: widget.proceedColor,
