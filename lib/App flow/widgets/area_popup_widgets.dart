...
class EditAreaPopup extends StatefulWidget {
...
@override
State<EditAreaPopup> createState() => _EditAreaPopupState();
}

class _EditAreaPopupState extends State<EditAreaPopup> {
static const primaryColor = Color(0xFFFD6464);
...
final oldName = widget.oldName.trim();
