...
class _SideBarWidgetsState extends State<SideBarWidgets> {
      ...
      child: InkWell(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            color:
            isSelected ? const Color(0xFFCBEEF9) : const Color(0xFF574CB0),
            borderRadius: BorderRadius.circular(4),
            boxShadow: const [
              BoxShadow(
  ...
  Widget build(BuildContext context) {
    ...
    return MultiBlocListener(
      listeners: [
        // 🟢 When categories are loaded, select the first one automatically
        ...
        // 🟡 When mini-subcategories are loaded, load first mini-subcategory products
