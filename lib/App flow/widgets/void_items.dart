...
class _VoidItemsDialogState extends State<VoidItemsDialog> {
  ...
  bool _isItemCancelled(KotItem item) {
    return item.isCancelled?.toLowerCase() == 'yes';
  }
  ...
  Widget _qtyButton({
    ...
    return InkWell(
      ...
      child: Container(
        ...
        height: 26,
        decoration: BoxDecoration(
          color: isCancelled ? Colors.grey.shade300 : const Color(0xFFFFE6E6),
          borderRadius: BorderRadius.circular(4),
        ),
        child: Icon(
          icon,
                                        ...
                                        return Container(
                                          ...
                                          child: Row(
                                            children: [
                                              ...
                                              // ✅ QUANTITY - Disabled for cancelled items
                                              Expanded(
                                                flex: 2,
                                                child: Row(
                                                  mainAxisAlignment: MainAxisAlignment.center,
                                                  children: [
                                                    // ➖ Minus button (disabled if cancelled)
                                                    _qtyButton(
                                                      icon: Icons.remove,
                                                      onTap: isCancelled
                                                          ? null
                                                    ...
                                                    const SizedBox(width: 8),
                                                    // ➕ Plus button (disabled if cancelled)
                                                    _qtyButton(
                                                      icon: Icons.add,
                                                      onTap: isCancelled
                                                          ? null
                                              ...
                                              // ✅ AMOUNT - Strikethrough if cancelled
                                              Expanded(
                                                flex: 2,
                                                child: Align(
                                                  alignment: Alignment.centerRight,
