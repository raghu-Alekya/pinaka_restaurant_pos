    ...
    on<SelectTable>((event, emit) async {
      ...
      try {
        ...
        if (existingOrder != null) {
          ...
          // Guestcount from existing order
          ...
          AppLogger.info(
            "✅ Loaded existing order with ${orderItems.length} items and ${kotList.length} KOTs, Guests: ${guestDetails.guestCount}",
          );
        } else {
