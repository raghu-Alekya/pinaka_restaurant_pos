...
class _KitchenDashboardScreenState extends State<KitchenDashboardScreen> {
  ...
  // Stores acceptance timestamp for online orders so the timer starts when accepted.
  final Map<String, DateTime> onlineAcceptedTimeMap = {};
    ...
    return Padding(
      ...
      child: InkWell(
        onTap: () async {
          ...
          // ==================================================
          // REMOVE EMPLOYEE LOGIN SESSION ONLY
          // ==================================================
            ...
            MaterialPageRoute(
              builder: (_) => EmployeeLoginScreen(
                ...
                onLoginSuccess: (config) {
                  // IMPORTANT:
                  // Do NOT use the old KitchenDashboard context here.
                    ...
                    MaterialPageRoute(
                      builder: (_) =>
                          KitchenDashboardScreen(
                            ...
                            // If your dashboard later needs storeId,
                            // you can pass:
                            //
      ...
      children: [
        Row(
          ...
          children: [
            ...
            // Refresh icon beside ACTIVE KOT'S
            InkWell(
              onTap: () async {
  ...
  Widget _buildReferenceFilter(
    ...
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          // Selected → active color for entire container
          color: selected
              ? activeColor
